...
//                .sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/auth/user-details")
                            .authenticated()
                        .requestMatchers("/api/leave-request/type").authenticated()
                        .requestMatchers( "/api/payroll/**").hasAnyAuthority("EMPLOYEE","HR", "PAYROLL_PROCESSOR","MANAGER")
                        ...
                        .requestMatchers("/api/payroll-policies/**").hasAnyAuthority("HR","PAYROLL_PROCESSOR")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/benefits/**").hasAnyAuthority("HR","PAYROLL_PROCESSOR")

                        .requestMatchers("/api/employee/**").hasAnyAuthority("EMPLOYEE", "MANAGER", "HR","PAYROLL_PROCESSOR")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/employee-benefits/get-all-benefitReq").hasAnyAuthority( "PAYROLL_PROCESSOR", "HR")
